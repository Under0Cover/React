...
class Jornal extends React.Component{
    ...
    render(){
        return(
            <div>
                <h3 className="titulo tituloNoticia">{this.props.noticia.titulo}</h3>
                <p className="texto">{this.props.noticia.texto}</p>
                <small className="autor">{this.props.noticia.autor}</small>
            </div>
        )
    }
}
